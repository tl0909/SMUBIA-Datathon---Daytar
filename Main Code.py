...
world_money['Risk_of_Economic-related_Crime'] = scaler.fit_transform(world_money[['Economic/Trade/Money-related']])
...
world_nomoney['Risk_of_NonMoney-related_Crime'] = scaler.fit_transform(world_nomoney[['Non-Money-related']])
