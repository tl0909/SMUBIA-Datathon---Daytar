...
final_df['Economic/Trade/Money-related_Ranking'] = final_df['Economic/Trade/Money-related_normalized'].rank(ascending=True)
final_df['Non-money-related'] = final_df['Non-money-related'].rank(ascending=True)
...
ax = world_money.plot(column='Economic/Trade/Money-related_normalized', cmap=cmap, legend=True,
                      legend_kwds={'label': "Economic/Trade/Money-related Risk by Country",
                                   'orientation': "horizontal"})
plt.title('Normalized Economic/Trade/Money-related Risk on World Map')
plt.show()
...
ax = world_nomoney.plot(column='Non-money-related_normalized', cmap=cmap, legend=True,
                        legend_kwds={'label': "Non-money-related Risk by Country",
                                     'orientation': "horizontal"})
plt.title('Normalized Non-money-related Risk on World Map')
plt.show()
...
top_20_money_sentiment = money_normalized_sentiment_scores.nsmallest(20, 'Economic/Trade/Money-related Sentiment Normalized')

# Extract top 20 countries for NoMoney Sentiment Normalized
top_20_no_money_sentiment = nomoney_normalized_sentiment_scores.nsmallest(20, 'Non-money-related Sentiment Normalized')
